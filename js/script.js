...
const config = {
    serverInfo: {
        serverLogoImageFileName: "minecraft_title.png", /*This is a file name for logo in /images/ (If you upload new logo with other name, you must change this value)*/
        serverName: "Novanest Network", /*Server name*/
        serverIp: "play.novanest.top", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1172389610924539925" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    adminTeamPage: {
        admins: [
            ...
            },
            {
                inGameName: "JayedYT",
                rank: "Admin",
                skinUrlOrPathToFile: "https://visage.surgeplay.com/bust/zombiewalkn.png",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "RAKESH_xD",
                rank: "Admin",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            }
        ...
        moderators: [
            ...
            {
                inGameName: "Lightx_death",
                rank: "Moderator",
                skinUrlOrPathToFile: "https://visage.surgeplay.com/bust/Madarchod.png",
                rankColor: ""
            }
